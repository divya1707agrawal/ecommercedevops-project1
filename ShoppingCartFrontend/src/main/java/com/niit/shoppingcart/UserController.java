...
public class UserController {
	...
	@ReturnMapping(value="/validate",method=RequestMethod.POST)
	public ModelAndView login(@RequestParam(value="username") String useID,@RequestParam(value="password")Str) String password.HttpSession session)
{
...
public ModelAndView logout(HttpServletRequest reuest){
