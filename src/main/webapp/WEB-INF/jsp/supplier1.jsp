...
%>
${msg}
<img src='<c:url value='/resources/images/shopping 1.jpg' />'  align="right" alt="This is image" width="650" height="220">
...
<tr>
 ...
 <tr>
  ...
  <input type="submit" value="<spring:message text="Add Supplier"/>"/>
   ...
   <img src='<c:url value='/resources/images/shopping 2.png' />'  align="right" alt="This is image" width="650" height="220">
     <h3>Supplier List</h3>
